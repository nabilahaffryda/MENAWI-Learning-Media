                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    @foreach ($materialdesc as $item)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $item->desc_id }}</td>
                                            <td>{{ $item->materi->material_name }}</td>
                                            ...
                                            <td>
                                                <div>
                                                    <a href="{{ route('materialdesc.edit', $item->desc_id) }}"
                                                        class="btn btn-primary btn sm">
                    ...
                    <div class="modal fade" id="smallmodal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                            <form action="{{ route('materialdesc.destroy', $item->desc_id) }}" method="POST">
                                @csrf
                                @method('DELETE')
