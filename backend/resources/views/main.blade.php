      ...
      <nav class="navbar navbar-expand-sm navbar-default">
         ...
         <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
               ...
               <li class="menu-item-has-children active dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Material</a>
                  <ul class="sub-menu children dropdown-menu">
                     <li><i class="fa fa-table"></i><a href="{{url('material')}}">Material</a></li>
                     <li><i class="fa fa-table"></i><a href="{{url('materialdesc')}}">Material Desc</a></li>
                  </ul>
               </li>
               <li class="menu-item-has-children dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-th"></i>Quiz</a>
                  <ul class="sub-menu children dropdown-menu">
                     ...
                     <li><i class="menu-icon fa fa-th"></i><a href="{{url('quizthemequestion')}}">Theme Question</a></li>
                     <li><i class="menu-icon fa fa-th"></i><a href="{{url('quizthemeanswer')}}">Theme Answer</a></li>
                  </ul>
               </li>
            </ul>
         </div>
